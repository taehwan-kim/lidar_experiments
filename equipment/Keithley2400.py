...
class Keithley2400:
    def __init__(self, resourcemanager, gpib_address = 24, wait = 0.5):
    ...
    def measCurrent(self, number_of_readings = 10, trigger_delay = 0.1, verbose = 1):
...
if __name__=='__main__':
    rm = visa.ResourceManager()
    supply = Keithley2400(rm, gpib_address = 24, wait = 0.5)
